  ...
  const projectData = projects.map((project) => {
    return (
        <li className = "App mt-12 p-10 bg-sky-100 rounded-2xl" key={project.id}>
            ...
            <button onClick={onButtonClick} className="bg-blue-500 text-white rounded mt-4 mx-auto p-2 sm:w-2/4 hover:bg-blue-800" value={project.id}>Mark Project as Complete</button>
        </li>
    );
  });
